...
class User_Test(unittest.TestCase):
    ...
    def test_dynamics_1(self):
        login = "Mari"
        self.assertEqual(
            db_user_dynamics(login, configtest), [("Mari", 1.0, 60.0, 55.0)]
        )
...
class Stat_Test(unittest.TestCase):  # очисти попытки
    ...
    def test_user_problem_letters_1(self):
        self.assertEqual(
            db_user_problem_letters("Mari", configtest), [("p", 8), ("o", 7), ("e", 2)]
        )
    ...
    def test_top_users_all_1(self):
        self.assertEqual(
            db_top_users_all(configtest),
            [
                ("Anna", 110.0, 6600.0, 100.0),
                ("Tom", 10.0, 600.0, 23.0),
                ("Mari", 4.5, 270.0, 60.0),
            ],
        )
